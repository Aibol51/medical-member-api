...
func (l *InitDatabaseLogic) insertApiData() (err error) {
	...
	_, err = l.svcCtx.CoreRpc.CreateApi(l.ctx, &core.ApiInfo{
		ServiceName: pointy.GetPointer("Other"),
		Path:        pointy.GetPointer("/appointment/create"),
		Description: pointy.GetPointer("apiDesc.createAppointment"),
		ApiGroup:    pointy.GetPointer("appointment"),
	...
	_, err = l.svcCtx.CoreRpc.CreateApi(l.ctx, &core.ApiInfo{
		ServiceName: pointy.GetPointer("Other"),
		Path:        pointy.GetPointer("/appointment/update"),
		Description: pointy.GetPointer("apiDesc.updateAppointment"),
		ApiGroup:    pointy.GetPointer("appointment"),
		Method:      pointy.GetPointer("POST"),
	})
	...
	_, err = l.svcCtx.CoreRpc.CreateApi(l.ctx, &core.ApiInfo{
		ServiceName: pointy.GetPointer("Other"),
		Path:        pointy.GetPointer("/appointment/delete"),
		Description: pointy.GetPointer("apiDesc.deleteAppointment"),
		ApiGroup:    pointy.GetPointer("appointment"),
		Method:      pointy.GetPointer("POST"),
	})
	...
	_, err = l.svcCtx.CoreRpc.CreateApi(l.ctx, &core.ApiInfo{
		ServiceName: pointy.GetPointer("Other"),
		Path:        pointy.GetPointer("/appointment/list"),
		Description: pointy.GetPointer("apiDesc.getAppointmentList"),
		ApiGroup:    pointy.GetPointer("appointment"),
		Method:      pointy.GetPointer("POST"),
	})
	...
	_, err = l.svcCtx.CoreRpc.CreateApi(l.ctx, &core.ApiInfo{
		ServiceName: pointy.GetPointer("Other"),
		Path:        pointy.GetPointer("/appointment"),
		Description: pointy.GetPointer("apiDesc.getAppointmentById"),
		ApiGroup:    pointy.GetPointer("appointment"),
		Method:      pointy.GetPointer("POST"),
	})
