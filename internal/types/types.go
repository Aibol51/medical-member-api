...
// Log in by Mobile request | 手机号登录参数
...
// swagger:model NewsListInfo
type NewsListInfo struct {
	BaseListInfo
	// The news list data | News信息列表数据
